...
(function(exports) {
  ...
  var classifier = function (sentences) {
      ...
      return function ($24) {
          return classify(stats)(tokenise($24));
      };
  };
...
(function(exports) {
  ...
  var showShaped = function (dictShow) {
      return new Data_Show.Show(function (v) {
          return "Shaped solid: " + (Data_Show.show(dictShow)(v.solid) + (" grey: " + Data_Show.show(dictShow)(v.grey)));
      });
  };
  var showDescriptionSection = new Data_Show.Show(function (v) {
      if (v instanceof Plain) {
          return "Plain " + Data_Show.show(Data_Show.showString)(v.value0);
      };
      if (v instanceof Linked) {
          return "Linked " + Data_Show.show(Data_Show.showString)(v.value0);
      };
      throw new Error("Failed pattern match at Main line 50, column 3 - line 50, column 38: " + [ v.constructor.name ]);
  });
  var shorten = function (a) {
      var $31 = Data_Array.unsnoc(a);
      if ($31 instanceof Data_Maybe.Nothing) {
          return [  ];
      };
      if ($31 instanceof Data_Maybe.Just) {
          return $31.value0.init;
      };
      throw new Error("Failed pattern match at Main line 165, column 13 - line 167, column 41: " + [ $31.constructor.name ]);
  };
  ...
  var sectionLength = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 62, column 1 - line 62, column 35: " + [ v.constructor.name ]);
  };
  ...
  var markupDescriptionSection = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 189, column 1 - line 189, column 65: " + [ v.constructor.name ]);
  };
  ...
  var linkCategories = function (categories) {
      var toSection = function (word) {
          ...
          throw new Error("Failed pattern match at Main line 148, column 9 - line 150, column 35: " + [ word.constructor.name ]);
      };
      return function ($76) {
          return Data_Functor.map(Data_Functor.functorArray)(toSection)(words($76));
      };
  };
  ...
  var markupDescriptionSections = function ($77) {
      return foldHTML(Data_Functor.map(Data_Functor.functorArray)(markupDescriptionSection)($77));
  };
  var exportAsMarginFile = function (state) {
      return Data_Functor.map(Data_Functor.functorArray)(fromEntryToMargin)(state.entries);
  };
  var eqShaped = function (dictEq) {
      return new Data_Eq.Eq(function (v) {
          return function (v1) {
              return Data_Eq.eq(dictEq)(v.solid)(v1.solid) && Data_Eq.eq(dictEq)(v.grey)(v1.grey);
          };
      });
  };
  var eqDescriptionSection = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof Plain && v1 instanceof Plain) {
              return v.value0 === v1.value0;
          };
          if (v instanceof Linked && v1 instanceof Linked) {
              return v.value0 === v1.value0;
          };
          return false;
      };
  });
  var descriptionSectionLength = function (v) {
      if (v instanceof Plain) {
          return Data_String.length(v.value0);
      };
      if (v instanceof Linked) {
      ...
      throw new Error("Failed pattern match at Main line 54, column 1 - line 54, column 46: " + [ v.constructor.name ]);
  };
  var descriptionSectionArrayLength = (function () {
      var f = function (b) {
          return function (a) {
              return b + descriptionSectionLength(a) | 0;
          };
      };
      return Data_Foldable.foldlDefault(Data_Foldable.foldableArray)(f)(0);
  })();
  var takeSections = function (__copy_v) {
      return function (__copy_v1) {
          var v = __copy_v;
          var v1 = __copy_v1;
          tco: while (true) {
              ...
              if (descriptionSectionArrayLength(shorten(v1)) >= v) {
                  var __tco_v = v;
                  var __tco_v1 = shorten(v1);
                  v = __tco_v;
                  v1 = __tco_v1;
                  continue tco;
              };
              ...
              throw new Error("Failed pattern match at Main line 172, column 1 - line 172, column 23: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var dropSections = function (m) {
      return function (a) {
          var taken = takeSections(m)(a);
          return Data_Array.drop(Data_Array.length(taken))(a);
      };
  };
  var crumbify = function (minutes) {
      return function (sections) {
          ...
          var f = function (delta) {
              ...
              throw new Error("Failed pattern match at Main line 158, column 1 - line 164, column 1: " + [ delta.constructor.name ]);
          };
  ...
  var processDescription = function (categories) {
      return function (description) {
          return function (minutes) {
              var sections = linkCategories(categories)(description);
              var solid = takeSections(minutes)(sections);
              var grey = dropSections(minutes)(sections);
              return {
  ...
  var renderEntry = function (classify) {
      return function (v) {
          ...
          var processed = (function (v1) {
              return v1;
          })(processDescription([ cat ])(v.description)(dur));
  ...
  var getTags = function ($78) {
      return Data_Functor.map(Data_Functor.functorArray)(cleanTag)(Data_Array.filter(isTag)(words($78)));
  };
      ...
      return function (de) {
          return function (st) {
              return function (state) {
                  ...
                  $73.entries = Data_Array.snoc(state.entries)(newEntry);
                  return $73;
              };
          };
      };
  ...
  exports["descriptionSectionArrayLength"] = descriptionSectionArrayLength;
  exports["descriptionSectionLength"] = descriptionSectionLength;
  exports["dropSections"] = dropSections;
  ...
  exports["takeSections"] = takeSections;
  exports["words"] = words;
  exports["eqDescriptionSection"] = eqDescriptionSection;
  exports["showDescriptionSection"] = showDescriptionSection;
  exports["eqShaped"] = eqShaped;
  exports["showShaped"] = showShaped;
